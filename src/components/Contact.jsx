      ...
      <div className="w-full max-w-7xl mx-auto z-10 flex flex-col justify-between h-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
          ...
          <div className="w-full text-left">
            ...
            <p className="text-gray-400 text-sm sm:text-base mb-10 max-w-md">
              Have an exciting project, opening, or question? Send me a message and I'll get back to you as soon as possible.
            </p>

            {/* Contact Card & Form */}
            <div className="glass p-8 sm:p-10 rounded-2xl border border-white/10 bg-[#121212]/40 backdrop-blur-md relative overflow-hidden max-w-xl">
                  ...
                  >
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-black border border-white/10 rounded-lg px-4 py-3 text-sm text-white focus:outline-none focus:border-neonBlue transition-colors"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        className="w-full bg-black border border-white/10 rounded-lg px-4 py-3 text-sm text-white focus:outline-none focus:border-neonBlue transition-colors resize-none"
